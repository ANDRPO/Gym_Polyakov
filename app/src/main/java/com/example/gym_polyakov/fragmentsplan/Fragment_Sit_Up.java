...
public class Fragment_Sit_Up extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_sit_up, null);
        tv_scores = view.findViewById(R.id.tv_scores_sit_up);
        tv_kcal = view.findViewById(R.id.tv_kcal_sit_up);
        final Button Tap = view.findViewById(R.id.b_tap_sit_up);
        final Button Stop = view.findViewById(R.id.b_stop_sit_up);
        chronometer = view.findViewById(R.id.chronometer_sit_up);
        ...
        Stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                chronometer.stop();
                final Button b_success = view.findViewById(R.id.b_success_sit_up);
                b_success.setTextSize(70);
                Tap.animate().alpha(0).setDuration(600);
                view.findViewById(R.id.container_button_sit_up).animate().translationYBy(-70).setDuration(600);
                Stop.animate().alpha(0).setDuration(600);
                view.findViewById(R.id.gif_sit_up).animate().alpha(0).setDuration(500);
